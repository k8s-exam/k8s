...
TOPICS = [
    ("a.core_concepts.md", "core-concepts", "Core Concepts", None,
      "Namespaces, pods, and kubectl basics."),
    ("b.multi_container_pods.md", "multi-container-pods", "Multi-container Pods", None,
      "Sidecars, init containers, and shared volumes."),
    ("c.pod_design.md", "pod-design", "Pod Design", None,
      "Labels, deployments, jobs, and cron jobs."),
    ("d.configuration.md", "configuration", "Configuration", None,
      "ConfigMaps, secrets, resources, and quotas."),
    ("e.observability.md", "observability", "Observability", None,
      "Probes, logging, and debugging."),
    ("f.services.md", "services-networking", "Services & Networking", None,
      "Services, endpoints, and NodePorts."),
    ("g.state.md", "state-persistence", "State Persistence", None,
